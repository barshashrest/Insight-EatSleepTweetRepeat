...
"""
	...
	def __init__(self, address, group, topic):
		...
		self.hadoop_path = "/Watching/TMDB/UP/HadoopHistory"
		self.topic = topic
		self.group = group
		self.tempfilepath = None
		self.tempfile=None
		self.blockcount=0
		self.cached_path= "/Watching/TMDB/UP/HadoopCached"
		self.csvfile = None
...
if __name__ == '__main__':
	...
	cons = ConsumeNPmovies(address="localhost:9092", group="hdfs", topic="nowplayingmovies")
